...
const data: TransactionTableData[] = [
  {
    ...
    account: { label: 'Checking' },
    date: { label: '2024-09-12T00:00:00Z' },
    method: 'wire',
  },
  {
    id: '326860b3',
        ...
        <div className='flex items-center gap-3 py-4'>
          <div className='flex-1'>
            <div className='flex items-center gap-1.5'>
              <div className='text-label-md text-text-strong-950'>All Cards</div>
