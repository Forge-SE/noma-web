...
function PageLogin() {
  ...
  return (
    <div className='w-full max-w-[472px] px-4'>
      <form onSubmit={handleLogin} className='flex w-full flex-col gap-6 rounded-20 bg-bg-white-0 p-5 shadow-regular-xs ring-1 ring-inset ring-stroke-soft-200 md:p-8'>
        ...
        <FancyButton.Root variant='primary' size='medium' type='submit' disabled={loading}>
