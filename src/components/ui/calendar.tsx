  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button:
          'absolute flex h-7 w-7 items-center justify-center rounded-md border border-stroke-soft-200 bg-bg-white-0 text-text-sub-600 hover:bg-bg-weak-50 hover:text-text-strong-950 transition-colors',
